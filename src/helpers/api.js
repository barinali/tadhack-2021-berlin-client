const AWA_API_URL = 'https://119pv3bbai.execute-api.eu-central-1.amazonaws.com/dev/awaproxy';
...
export const simulateNumbers = async (numbers = []) => {
  const response = await fetch(`${AWA_API_URL}?withoutIncurringCost=false&currency=USD`, {
    "headers": {
